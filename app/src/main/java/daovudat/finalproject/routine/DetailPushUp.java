...
public class DetailPushUp extends AppCompatActivity{
            ...
            public void onClick(View v) {
                ...
                if (mark != 4) {
                    ...
                    else if (count == 8 && unlock == true)
                    {
                        count1++;
                        CurExe.setText("Rest");
                        NexExe.setText("Diamond Push Ups");
                        new CountDownTimer(3000, 500) {
                            public void onTick(long millisUntilFinished) {
                                unlock = false;
                                reps.setText("" + String.format(FORMAT,
                    ...
                    {
                        CurExe.setText("Diamond Push Ups");
                        NexExe.setText("Rest");
                        reps.setText("3 reps");
                        count++;
                    ...
                    else if (count == 10 && unlock == true)
                    {
                        count1++;
                        CurExe.setText("Rest");
                        NexExe.setText("Incline Push Ups");
                        new CountDownTimer(3000, 500) {
                            public void onTick(long millisUntilFinished) {
                                unlock = false;
                                reps.setText("" + String.format(FORMAT,
                    ...
                    {
                        CurExe.setText("Incline Push Ups");
                        NexExe.setText("Rest");
    ...
    public void sth()
    {
        new AlertDialog.Builder(this,R.style.MyDialogTheme)
                ...
                .setCancelable(false)
                .setMessage("You have finished the PUSH UPS. You got 2 point and 2 exp.")
