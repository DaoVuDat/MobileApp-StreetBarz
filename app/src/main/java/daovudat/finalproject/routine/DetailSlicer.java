 ...
 */
public class DetailSlicer extends AppCompatActivity  {
    ...
    public void sth()
    {
        new AlertDialog.Builder(this,R.style.MyDialogTheme)
                ...
                .setCancelable(false)
                .setMessage("You have finished the SLICER. You got 1 point and 1 exp.")
