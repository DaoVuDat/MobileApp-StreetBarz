 ...
 * Created by Dao Vu Dat on 9/8/2016.
 */
public class DetailMissionFit extends AppCompatActivity{
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mark != 4) {
                    ...
                    {
                        CurExe.setText("Crunches");
                        NexExe.setText("Rest");
                        reps.setText("22 reps");
                        count++;
                    }
                    ...
                    else if (count == 6 && unlock == true)
                    {
                        count1++;
                        CurExe.setText("Rest");
                        NexExe.setText("Side Plank Right");
                        new CountDownTimer(3000, 500) {
                            public void onTick(long millisUntilFinished) {
                                unlock = false;
                                reps.setText("" + String.format(FORMAT,
                    ...
                    {
                        CurExe.setText("Side Plank Right");
                        NexExe.setText("Rest");
                        new CountDownTimer(3000, 500) {
                            public void onTick(long millisUntilFinished) {
                                unlock = false;
                    ...
                    else if (count == 8 && unlock == true)
                    {
                        count1++;
                        CurExe.setText("Rest");
                        NexExe.setText("Side Plank Left");
                        new CountDownTimer(3000, 500) {
                            public void onTick(long millisUntilFinished) {
                                unlock = false;
                                reps.setText("" + String.format(FORMAT,
                    ...
                    {
                        CurExe.setText("Side Plank Left");
                        NexExe.setText("Rest");
                        new CountDownTimer(3000, 500) {
                            public void onTick(long millisUntilFinished) {
                                unlock = false;
    ...
    public void sth()
    {
        new AlertDialog.Builder(this,R.style.MyDialogTheme)
                ...
                .setCancelable(false)
                .setMessage("You have finished the MISSION FIT. You got 1 point and 1 exp.")
